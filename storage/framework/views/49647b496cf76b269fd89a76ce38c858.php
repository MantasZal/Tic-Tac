...
<?php endif; ?>
    ...
    <div class="mt-5 md:mt-0 md:col-span-2">
        <form wire:submit="<?php echo e($submit); ?>">
            <div
                class="px-4 py-5 bg-white sm:p-6 shadow <?php echo e(isset($actions) ? 'sm:rounded-tl-md sm:rounded-tr-md' : 'sm:rounded-md'); ?>">
...
<?php /**PATH C:\Users\manta\Downloads\Tic-Tac\resources\views/components/form-section.blade.php ENDPATH**/ ?>