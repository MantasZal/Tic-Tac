...
<div x-data="{ shown: false, timeout: null }" x-init="window.Livewire.find('<?php echo e($_instance->getId()); ?>').on('<?php echo e($on); ?>', () => {
...
<?php /**PATH C:\Users\manta\Downloads\Tic-Tac\resources\views/components/action-message.blade.php ENDPATH**/ ?>